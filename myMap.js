// var imgAdrs = 'http://61.177.139.106:5672/sanwei'; // 修改 开发地址
var imgAdrs = 'http://68.168.75.92:5672/shanwei'; // 修改 // 汕尾内网--68.168.75.92
window.TILE_VERSION = {
  "ditu": {
      "normal": {
          "version": "088",
...
window.BMAP_AUTHENTIC_KEY = "9jiDpwILU0Y8btyedBGNkphEGXXEGnan";
(function() {
  function aa(a) {
      throw a;
  }
      ...
      void function(a, b, c) {
          ...
          function k(a, b, c) {
              if (a) {
                  ...
                  try {
                      a == G ? (Q[b] = Q[b] || [],
                      Q[b].unshift(c)) : a.addEventListener ? a.addEventListener(b, c, q) : a.attachEvent && a.attachEvent("on" + b, c)
                  } catch (d) {}
              }
          }
          function l(a, b, c) {
  ...
  ;function ra(a, b) {
      console.log(a, 1)
      if (/^http/.test(a)) return; // 修改 这里判断一下，如果是调用外部资源就退出去好了；
              ...
              if (d.Dd == this.Lj.IG) {
                  ...
                  setTimeout(function() {
                    ...
                    //   0 == a.length ? e.pL() : ra(e.BG.vQ + "&mod=" + a.join(",")) 
                      console.log(a, 2); // 修改 这里很重要！帮助我们找到我们需要加载的模块！
                      0 == a.length ? e.pL() : ra(import("./getmodules2.js"))
                  ...
                  for (var c = "ahl"; b[V("0xe")](c, V("0x5")); )
                      ...
                      case V("0x4"):
                          f = setTimeout(function() {
                              ...
                              }, c = V("0x10"); b[V("0xe")](c, V("0x11")); )
                                  switch (c) {
                                  case b.lacae:
                                      ra(d, function(b) {
                                          (!b || a.xamdx(b[a[V("0x12")]], j) || 0 !== b[V("0x13")]) && Jc(V("0x0"), function(b) {
                                              (!b || a[V("0x14")](b[V("0x13")], j) || 0 !== b[a[V("0x12")]]) && Kc(a[V("0x15")])
                                          })
                                      });
                                      c = b.aehid;
                                      break;
                                  case V("0x10"):
                                      var d = b[V("0x16")](B.JN + V("0x17") + qa, V("0x18")) + e
                                        , c = V("0x1");
                                      break;
                                  case V("0x19"):
                                      f = p;
  ...
  function Mc(a, b) {
      for (var c = {
          ...
          switch (d) {
          case c[V("0x2b")]:
              var e = c.mcehl(c[V("0x2c")](a, "-") + c[V("0x2d")](m, n) + "-0-0-", l)
                , d = V("0x23");
              break;
          case c[V("0x2e")]:
              return s;
          ...
          case V("0x3f"):
              ...
              break;
          case c[V("0x40")]:
              var s = c[V("0x2d")](c.execx(c[V("0x41")], c[V("0x42")](m, n)) + c[V("0x43")], k)
                , d = V("0x25");
              break;
          case c[V("0x44")]:
              g = 1,
  ...
  function Jc(a, b) {
      ...
      case V("0x0"):
          ...
          c[V("0x48")](typeof b, c[V("0x49")]) ? ra(d, b) : ra(c[V("0x4a")](c[V("0x4a")](d, "& callback="), b))
      }
  }
  function Kc(a) {
      var b = {
                  ...
                  if (e.xO == o) {
                      ...
                      e.getTilesUrl = function(b, d) {
                          var e = b.x  // x
                            ...
                            , m = 1;
                          this.map.Xx() && (m = 2);
                          // 修改 使用的时候添加了自定义样式的:mapStyle="mapItem.mapStyle"，应找应该隐藏以下三行，放开下面两行
  ...
  Vd.getTilesUrl = function(a, b, c) {
      ...
      return imgAdrs+'/'+b+'/'+d+'/'+a+'.png' // 修改 文件根目录 +  '/' + 缩放等级 +  '/' + x坐标 + '/' + y坐标 + 瓦片后缀名
